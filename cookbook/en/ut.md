...
- `tests/unit`: Minimal checks for individual modules/functions—useful for understanding low-level APIs.
- `tests/sandbox`: Scenario-style scripts focused on sandbox capabilities, such as `test_sandbox.py` and `test_sandbox_service.py`.
